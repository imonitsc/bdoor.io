...
| `CRON_SECRET`                          | for scheduled jobs | Bearer token for the nightly jobs: the conversation-retention sweep, the compliance reminder run and the renewal-offer run. Unset, they all refuse with 503. |
| `SENTRY_DSN`                           | no                 |                                                                                                                                                              |
