# bdoor legal policy content pack — English

**Legal entity:** bdoor compliance ltd.  
**Website:** https://www.bdoor.io/  
**Contact:** hello@bdoor.io  
**Draft version:** 0.9  
**Draft date:** 29 August 2026  
**Status:** Complete working draft for Bangladesh-lawyer and compliance-officer review. It must not be labelled “final”, used to accept payment, or used to collect KYC documents until formally approved.

This pack provides substantive copy for every policy currently linked in the bdoor footer and the additional policies needed for a B2B2C formation platform. It deliberately does not state an office address. If a statutory notice address is legally required, counsel must add the correct registered-office details before approval.
...
These Terms govern access to bdoor.io and the services coordinated by bdoor compliance ltd. (“bdoor”, “we”, “us” or “our”). By using the website, creating an account, submitting an application or accepting a quotation, you agree to the version of these Terms shown to you at that time.
...
## 1.2 Independent platform

bdoor is an independent business-setup and compliance coordination platform. It is not a government authority and does not issue registrations, licences, tax numbers, visas or approvals. Government authorities retain sole discretion over their decisions and timelines.
...
You must be at least 18 years old and legally capable of entering into a contract. If you act for a company, partnership, founder group or another person, you confirm that you have authority to provide instructions and information on their behalf.
...
## 1.4 Free applications and formation assessments

A free application, questionnaire result, initial estimate or specialist review is non-binding. It does not create a paid engagement, reserve a company name, guarantee eligibility, appoint a professional provider or begin a government filing.
...
## 1.6 Quotations, prices and third-party costs

Prices may be displayed in BDT or USD for convenience. Every binding quotation must separate:
...
Payment must be made through an approved payment method and in the currency stated on the invoice. You authorise bdoor and its payment processors to process the amount shown at checkout or on an accepted invoice.
...
## 1.8 Government and provider decisions

Estimated timelines begin only after complete documents, cleared funds and all required approvals are received. Timelines exclude customer delays, government closures, enhanced review, name objections, banking review, courier time and events outside reasonable control.
...
## 1.9 Third-party professional services

Where a third party performs regulated or jurisdiction-specific work:
...
## 1.10 Accounts and security

You are responsible for protecting your login credentials and for activity performed through your account. Tell us immediately if you suspect unauthorised access. We may require multi-factor authentication, identity re-verification or additional controls for sensitive actions.

## 1.11 Acceptable use

You must comply with the Acceptable Use Policy. We may refuse, suspend or terminate access where use is unlawful, deceptive, abusive, unsafe or inconsistent with compliance obligations.

## 1.12 Intellectual property

The website, platform software, brand, layout and original content belong to bdoor or its licensors. You may use service outputs supplied specifically for your matter for their intended business purpose. Government forms, laws, official guidance and customer-owned material remain subject to their respective rights.

## 1.13 Confidentiality and data
...
We may pause or end a service if:
...
Nothing in these Terms excludes liability that cannot lawfully be excluded. Subject to that rule, bdoor is responsible only for direct loss reasonably caused by its failure to perform the coordination service with reasonable care and skill. bdoor is not responsible for indirect loss, lost profit, loss caused by inaccurate customer information, or a decision or delay of a government authority, bank or independent provider outside bdoor’s reasonable control.
...
## 1.16 Complaints and disputes

Raise a complaint under the Complaints Policy. We will first try to resolve the matter in good faith. These Terms are governed by the laws of Bangladesh. Unless mandatory law gives another forum, disputes that cannot be resolved informally are subject to the competent courts of Bangladesh. This clause does not remove any non-waivable consumer right.

## 1.17 Changes and notices

We may update these Terms for legal, operational or security reasons. Material changes will be highlighted before they apply to an existing paid service. Each acceptance record must identify the policy version, language, timestamp and user.
...
A cross-border formation request may require data to be processed in the selected jurisdiction. Technology and professional providers may also process data outside Bangladesh. Before such transfer, bdoor must identify the purpose, recipient category, destination and applicable safeguard or lawful basis. We will not claim that every overseas jurisdiction offers equivalent protection.

## 2.6 Retention

We keep personal data only for as long as needed for the stated purpose, legal duties, dispute handling and security. The production retention schedule must be approved by counsel and configured by data category. The intended schedule is:
...
Cookies and similar technologies are governed by the Cookie Policy. Non-essential analytics or advertising technologies must not load until the required choice has been obtained. Sensitive application, KYC and document pages must be excluded from session replay.

## 2.11 Children

The service is intended for adults and business representatives. We do not knowingly collect applications from anyone under 18. If such data is identified, the application will be closed and the data deleted unless law requires otherwise.

## 2.12 Changes and contact

Material changes will be shown with a new version and effective date. Privacy questions and requests may be sent to hello@bdoor.io. Formal role titles and regulatory contact details must be added when appointed and legally required.
...
This Policy explains how bdoor handles cancellation, unused service fees, government charges and third-party costs. It forms part of the Terms of Service and does not remove any mandatory consumer right.

## 3.2 Before a paid engagement begins

Submitting a free application creates no payment obligation. If a customer pays but bdoor has not started work, appointed a provider, made a filing or committed any third-party cost, the customer may cancel and receive a refund of the amount received. Any payment-provider charge that cannot be recovered may be deducted only if it was disclosed before payment and bdoor does not retain it.

## 3.3 After work begins

If the customer cancels after work starts, bdoor will provide an itemised closing statement showing:
...
## 3.4 Rejection, delay or customer ineligibility
...
## 3.5 Customer-caused closure

bdoor may close a matter if the customer supplies false or altered documents, conceals ownership, does not answer required checks, requests unlawful activity, fails to pay an agreed invoice or remains inactive after reasonable reminders. Completed work and committed costs remain chargeable; unused funds will be handled lawfully and may be held where a legal restriction prevents repayment.

## 3.6 Duplicate and unauthorised payments
...
## 3.7 How to request cancellation or refund

Email hello@bdoor.io with the subject “Cancellation or refund”, the customer name, application or invoice reference, payment date, amount and reason. Do not send full card or mobile-wallet credentials.
...
## 3.8 No misleading guarantee

Marketing must not state “money-back guarantee”, “guaranteed approval” or “full refund” unless the exact conditions have been approved by counsel and are shown immediately beside the claim.

---

# 4. AML, KYC and Sanctions Policy

## 4.1 Purpose and scope

bdoor supports lawful business formation and compliance. It does not assist anonymous ownership, sanctions evasion, money laundering, terrorist financing, proliferation financing, bribery, tax evasion, fraud or concealment of criminal proceeds.
...
## 4.2 When checks occur

The free initial application should collect only the minimum non-sensitive information needed for routing and assessment. Identity documents and detailed source-of-funds evidence may be requested only after:
...
Depending on risk and jurisdiction, bdoor or the appointed regulated provider may verify:
...
Additional review may be required for complex or unusual structures, high-risk jurisdictions, politically exposed persons, sanctioned-country exposure, cash-intensive or regulated activity, nominee arrangements, inconsistent documents, unexplained third-party payments, adverse information or unusually urgent instructions.
...
Screening must use the lists and legal restrictions applicable to bdoor, the customer, payment provider, appointed professional and requested jurisdiction. This may include United Nations and Bangladesh domestic sanctions and locally required lists. A possible match must be reviewed by an authorised person; an unreviewed software match must not be treated as proof.

## 4.6 Monitoring and reporting

bdoor will monitor relevant customer and case information for material inconsistencies or suspicious activity. Where bdoor or an appointed provider has a legal reporting obligation, a report may be made to the competent authority without customer consent and without notice where notice is prohibited. Only a properly authorised compliance person may decide or submit a report on bdoor’s behalf.

## 4.7 Refusal, restriction and exit

bdoor may decline, suspend or terminate a relationship where required information is unavailable, risk cannot be adequately managed, instructions may be unlawful, a sanctions restriction applies or a provider cannot accept the matter. bdoor is not required to disclose confidential risk rules or information whose disclosure would be unlawful.

## 4.8 Records and confidentiality

Due-diligence and case records will be kept for the legally required period under the approved retention schedule, protected with restricted access and disclosed only for an authorised purpose. Staff and providers must not discuss suspicious-activity reviews outside authorised channels.

## 4.9 Governance

Before launch, bdoor must appoint an accountable AML/compliance lead, approve a business-wide risk assessment, document customer-risk scoring, train relevant staff, define escalation and reporting procedures, test the controls and maintain a current sanctions source list. Public wording must never imply BFIU endorsement.
...
Cookies and similar storage technologies allow a website to remember information about a browser or device. This Policy explains the categories bdoor may use and the choices available.
...
Cursor must generate the production cookie register by auditing actual code, response headers and third-party scripts. The register must show cookie or storage key, provider, purpose, category, duration and whether information is transferred internationally. Do not invent vendor names or cookie durations.

## 5.4 Choices

On first eligible visit, show a clear choice to accept, reject or customise non-essential cookies. Reject must be as easy as accept. Consent must be granular, recorded by version and withdrawable through a persistent “Cookie settings” link in the footer.
...
Update this Policy and the consent record when categories or vendors materially change. Questions may be sent to hello@bdoor.io.

---

# 6. Legal and Professional Services Disclaimer

Information on bdoor.io is general business-setup information and does not constitute legal, tax, accounting, audit, investment, immigration or financial advice. It should not be relied on as a substitute for advice based on a customer’s facts.

bdoor is independent from government. Government names and links identify the authority responsible for a process; they do not indicate partnership, authorisation, endorsement or priority treatment. Do not use government logos without written permission.

Eligibility rules, fees, exchange rates, forms and processing times may change. A displayed price or timeline is an estimate unless included in an accepted written quotation. The responsible authority or provider makes the final decision.

Regulated work is performed by an appropriately qualified third party where required. Customers must receive the provider’s identity, role, price and applicable terms before engagement. bdoor does not guarantee the outcome of a government, bank, tax, immigration or professional decision.

English and Bangla content should communicate the same meaning. If an inconsistency affects a service, ask bdoor for confirmation before acting. Any clause stating that one language automatically prevails must be approved by counsel.

External links are provided for convenience. bdoor is not responsible for an external site’s availability or content, although official sources should be used wherever possible.

For a decision with legal, tax or financial consequences, request advice from the qualified professional assigned to the matter.
...
Email hello@bdoor.io with the subject “Complaint”. Include your name, application or case reference, the service or provider involved, what happened, the outcome you seek and any relevant non-sensitive evidence. Do not send card credentials or identity documents by ordinary email.

## 7.2 Handling process
...
## 7.3 Provider complaints

If the complaint concerns an independent professional, bdoor may share the relevant complaint information with that provider and coordinate its response. This does not remove any right to complain directly to the provider’s professional body or regulator.

## 7.4 No retaliation and recordkeeping

Making a good-faith complaint will not result in retaliation. Complaint records will be restricted, retained under the approved schedule and analysed for recurring problems.

## 7.5 External rights

Nothing in this Policy prevents a customer from using a court, regulator, professional body, payment-provider dispute process or Bangladesh consumer complaint route available under applicable law. The National Consumer Complaint Centre currently publishes hotline 16121 and an online complaint route; Cursor must link to the current official DNCRP page rather than hard-code an unofficial domain.

---

# 8. Acceptable Use Policy

You must not use bdoor to:

- create, acquire or operate a business for an unlawful or deceptive purpose;
- conceal a beneficial owner, controller, source of funds or sanctioned interest;
- submit forged, altered, stolen or misleading information or documents;
- impersonate another person or act without authority;
- evade tax, sanctions, licensing, foreign-exchange or reporting requirements;
- facilitate bribery, fraud, trafficking, terrorism, money laundering or other crime;
- upload malware, exploit security weaknesses or disrupt the platform;
- access another customer’s, provider’s or employee’s information;
- scrape, reverse engineer or automate access contrary to written permission;
- harass staff, providers or customers;
- infringe intellectual-property, privacy or confidentiality rights; or
- resell a service deceptively or claim government endorsement.

bdoor may block an action, preserve evidence, request additional verification, suspend access or terminate a matter. Information may be disclosed when lawfully required. Where safe and lawful, bdoor will explain the restriction and provide a review route.

Security vulnerabilities should be reported privately to hello@bdoor.io with the subject “Security report”. Do not publicly disclose customer data or exploit a vulnerability beyond what is necessary to demonstrate it safely.

---

# 9. Third-Party Professional and Provider Disclosure

## 9.1 B2B2C operating model

bdoor coordinates services through vetted third-party firms and specialists where it does not perform the work itself. These may include law firms, chartered-accountancy firms, company-secretarial practices, registered agents, corporate-service providers, tax practitioners, banks, immigration specialists, notaries, translators and licensing consultants.

## 9.2 Before engagement

Before a provider is appointed, the customer must receive:
...
## 9.3 Customer choice and consent
...
Each provider is responsible for its own professional judgement, regulated obligations and deliverables. bdoor remains responsible for the coordination, platform and support commitments stated in its quotation. A customer must not be passed between bdoor and a provider without a clear owner for the complaint or next action.

## 9.5 Conflicts, quality and replacement

Providers must disclose relevant conflicts and protect confidential information. bdoor may reassign a matter for conflict, capacity, quality, credential or risk reasons. A material change in provider, scope, fee or timing requires customer notice and, where appropriate, renewed consent.

## 9.6 No government endorsement

An external provider’s registration or professional membership does not make bdoor government-approved or endorsed. Government and regulator logos must not be displayed without written permission.

---

# 10. Electronic Communications and Consent Policy

bdoor may send transactional communications needed to administer an application, account, quotation, payment, case, compliance deadline, security event or policy change. These are different from promotional marketing.

By supplying an email address or authorised messaging number, the customer agrees to receive necessary service communications through that channel. Marketing requires the permission required by applicable law and always includes an effective opt-out. Opting out of marketing does not stop essential service or security messages.

Where electronic acceptance is used, bdoor must display the document or action clearly and record the user, policy or contract version, language, timestamp, IP or security context, and the affirmative action taken. Pre-ticked acceptance boxes are prohibited.

Email and messaging services are not appropriate for sending identity documents unless bdoor has expressly designated a secure channel. Customers should use the private workspace for sensitive documents.

A customer may request a copy of an electronically accepted document or update communication preferences through the account or by contacting hello@bdoor.io.

---

# Implementation manifest for Cursor
...
- legal entity name: `bdoor compliance ltd.`;
- substantive content, not a generic placeholder;
- version, draft/approved status and last-updated date;
- in-page table of contents on desktop and compact disclosure on mobile;
- print-friendly styling;
- `noindex` while status is Draft;
- canonical and locale metadata after approval;
- a link to `hello@bdoor.io`;
- a link back to the full policy index;
- no invented address, registration number, officer name or credential; and
- no statement that bdoor is approved by BFIU, RJSC, BIDA or another authority.

Create `/[locale]/legal` as a policy index. Add every approved policy to the footer under one restrained “Legal” column. Do not display ten separate links in the global footer on small screens; use the policy index plus the six core links.

For Bangla routes, provide a complete professional translation with the same clause IDs and meaning. Until that translation is professionally reviewed, display the complete English draft with a prominent Bangla notice that the Bangla version is being legally reviewed. Do not publish a shortened Bangla summary as though it were the full policy and do not use automatic translation in production.

Acceptance records must contain at least:

- `user_id` or pre-auth application identity;
- `policy_type`;
- `policy_version`;
- `locale`;
- `accepted_at`;
- request/security metadata permitted by the Privacy Policy; and
- the exact content hash or immutable policy-document reference.

Never combine marketing consent, cookies, Terms, Privacy acknowledgement and provider document sharing into one checkbox.

---

# Approval and launch checklist

The policy status may change from Draft to Approved only when all items are complete:

1. Bangladesh lawyer reviews Terms, disclaimer, refund and consumer clauses.
2. Privacy adviser or lawyer maps the Privacy and Cookie Policies to the Personal Data Protection Act, 2026 and actual data flows.
3. AML/compliance adviser confirms whether bdoor is a trust and company service provider/reporting organisation and approves operational procedures.
4. Actual subprocessors, payment providers and cross-border data destinations are inventoried.
5. Actual retention periods are approved and technically enforced.
6. Customer quotation, provider engagement and refund workflows match the written policies.
7. Bangla translations receive legal/linguistic review.
8. Database policy-version records and server-side acceptance gates pass tests.
9. `LEGAL_LAUNCH_APPROVED=true` is set only in the approved production environment by an authorised owner.
10. A signed approval record identifies approver, date, version and documents.

---

# Official source register checked 29 August 2026

These sources informed the issue list and must be rechecked by counsel; they do not replace legal advice:

- Personal Data Protection Act, 2026: https://bdlaws.minlaw.gov.bd/act-details-1692.html
- Personal data accountability and transparency, section 15: https://bdlaws.minlaw.gov.bd/act-1692/section-57281.html
- Consent withdrawal, section 13: https://bdlaws.minlaw.gov.bd/act-1692/section-57279.html
- Data correction/update/completion, section 12: https://bdlaws.minlaw.gov.bd/act-1692/section-57278.html
- Record retention, section 19: https://bdlaws.minlaw.gov.bd/act-1692/section-57285.html
- Contract Act, 1872: https://bdlaws.minlaw.gov.bd/act-details-26.html
- Consumer Rights Protection Act, 2009: https://bdlaws.minlaw.gov.bd/act-details-1014.html
- Promised paid goods/services, Consumer Rights Protection Act section 45: https://bdlaws.minlaw.gov.bd/act-1014/section-39153.html
- Money Laundering Prevention Act, 2012: https://bdlaws.minlaw.gov.bd/act-details-1088.html
- BFIU reporting-organisation FAQ: https://www.bfiu.org.bd/index.php/others/faq
- BFIU Circular No. 13 listing trust/company-service and professional sectors: https://www.bfiu.org.bd/index.php/legislation/circular
