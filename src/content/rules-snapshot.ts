...
export const SNAPSHOT_RULES: Rule[] = [
  {
    ...
    "description": "Any foreign founder or foreign ownership needs a partner eligibility review first.",
    "conditions": {
      "any": [
        {
  ...
  },
  {
    ...
    "outcome": {
      "assumptions": [
        "Sector approval is a separate decision by the relevant regulator."
      ],
      "manualReview": true,
      "manualReviewReasons": [
  ...
  {
    "key": "import-adds-irc",
    "description": "Importing requires an IRC, which itself requires a trade licence, TIN, BIN and bank account.",
    "conditions": {
      "any": [
        {
          "field": "import_export",
  ...
  },
  {
    ...
    "outcome": {
      ...
      "partnerQuestions": [
        "Confirm the current ERC application route for this product category."
      ]
    },
    "priority": 51
  },
  {
    ...
    "description": "Founders intending to work in Bangladesh must be told incorporation is not immigration.",
    "conditions": {
      "all": [
        {
    ...
    "outcome": {
      ...
      "partnerQuestions": [
        "Which visa category fits the founder's intended role?"
      ]
    },
    "priority": 60
  },
