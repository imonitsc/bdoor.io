...
function PackageCards({
  ...
  /** Homepage: name, audience, fee, three inclusions, CTA — no disclosure. */
  compact?: boolean;
}) {
  ...
  return (
    <ul className="mt-8 grid gap-4 md:grid-cols-1 xl:grid-cols-3">
      {packages.map((pkg) => {
        ...
        return (
          <li key={pkg.slug}>
            ...
            >
              ...
              {!compact && (remaining.length > 0 || version.exclusions.length > 0) ? (
