...
## Firstbase-Inspired Master Claude Code Product, Engineering and Fundability Instruction
...
**Status:** This replaces the earlier bdoor AI/Business Intelligence OS product instruction
...
Use the proven operating logic demonstrated by platforms such as Firstbase, Stripe Atlas and doola: formation is the acquisition product; continuing compliance, bookkeeping, business operations and partner services create recurring revenue and retention. Do not copy their US terminology, designs, content, pricing, code, protected data, partner relationships or legal assumptions. Translate the model into Bangladesh's actual authorities, entity types, taxes, licences, workflows and professional-service boundaries.
...
8. One coherent product family: bdoor AI, Start, Comply, Books, Address and Connect.
...
## 1A. Researched operating model to adapt

The implementation must be informed by these verified product patterns without duplicating another company's expression:

### Firstbase pattern

- Start uses one application to choose entity/location, prepare formation, obtain tax identity, provide post-incorporation documents and connect the new company to banking and later products.
- Agent turns mandatory continuing compliance, notices, deadlines and filings into an annual recurring product and dashboard.
- Mailroom combines a permitted business address, incoming-mail operations, digitisation, team access and paid forwarding.
- Loop uses existing company data to reduce friction when applying for banking, payments, payroll, accounting and other tools.
- Accounting combines software, automated categorisation and reconciliation with human bookkeeping and tax-ready statements.
- Discovery is opt-in investor visibility; Rewards creates customer value and partner distribution; incorporation/referral APIs extend distribution through third parties.

### Stripe Atlas pattern

- A single structured application drives document generation, signatures, incorporation and tax-identity workflows.
- Post-incorporation governance and founder-equity documents are visible in one dashboard.
- Banking and payments are applications to third-party providers, never guaranteed approvals.
- Special situations are explicitly routed to legal/tax professionals instead of forced through standard templates.

### doola pattern

- Formation, compliance, bookkeeping and tax are bundled into increasingly valuable annual back-office plans.
- The highest-value tier is not a formation package; it is a continuing operational relationship with a bookkeeper, financial reporting and compliance support.

### Bangladesh translation

- Bangladesh has no direct equivalent to the US registered-agent product. Use **bdoor Comply**, not “registered agent,” as the recurring compliance layer.
- A registered office, trade-licence premises, VAT address, bank KYC address and sector-licence premises may have different evidence and inspection requirements. **bdoor Address** must never imply that one address automatically satisfies every authority.
- RJSC, local-government trade licensing, NBR, BIDA/Invest Bangladesh, Bangladesh Bank and sector regulators remain independent authorities. bdoor coordinates; it does not approve.
- Bookkeeping may be delivered through bdoor and qualified accounting providers, but statutory audits and reserved professional work remain with appropriately authorised independent professionals.
- BanglaBiz/OSS and government portals may overlap with bdoor's workflows. bdoor's advantage must be intelligence, one-time data capture, preparation, visibility, orchestration and continuing compliance—not pretending to replace government portals.

This research creates the product rule:

> **One business profile should power formation, compliance, books, address, partner onboarding and investor readiness without asking the founder for the same fact repeatedly.**
...
### 4.0 Product family and naming

Use these customer-facing products consistently:

| Product           | Job                                                      | Primary revenue                                   | Availability goal              |
| ----------------- | -------------------------------------------------------- | ------------------------------------------------- | ------------------------------ |
| **bdoor AI**      | Answer, assess, calculate and route                      | Free-to-paid acquisition and premium intelligence | First                          |
| **bdoor Start**   | Form or onboard a business                               | One-time formation/service revenue                | First                          |
| **bdoor Comply**  | Track and coordinate continuing obligations              | Annual/monthly recurring revenue                  | First                          |
| **bdoor Books**   | Bookkeeping and tax-ready financial records              | Monthly/annual recurring revenue                  | Second                         |
| **bdoor Address** | Permitted address and digital mail operations            | Monthly/annual recurring revenue                  | Controlled pilot               |
| **bdoor Connect** | Consent-based access to verified business tools/partners | Referral, integration or enterprise revenue       | After signed partnerships      |
| **bdoor ID**      | Private verified business identity and shared data layer | Retention, verification and platform moat         | Foundation across all products |

These are connected product modes, not separate websites. Use one login, one organisation profile, one document vault, one timeline, one permissions system, one audit log and one billing relationship.

The normal header must remain minimal: **Start**, **Ask bdoor AI**, language and account/Start action. Place the full product family in a concise Products menu only when navigation can remain simple; otherwise present it inside the signed-in workspace and footer. Do not create a crowded Firstbase-style mega-navigation.

### 4.0.1 One-time data capture

Create a canonical business profile schema and field provenance system. Every fact must record who supplied it, when, supporting document, verification status and the workflows permitted to reuse it.

Before asking a question, check whether a current verified value already exists. Show the existing value and ask the customer to confirm or update it. Do not silently reuse stale or conflicting facts.

### 4.0.2 New versus existing business

Every product must support both:

- **Start a new business** — use bdoor Start to create the profile and formation case.
- **Add an existing business** — import, verify and organise an already registered company/proprietorship, then offer Comply, Books, Address and Connect.

Do not force existing businesses through the new-formation funnel.
...
bdoor Start is the acquisition product. Use a single adaptive intake for:

- Sole proprietorship.
- Partnership firm.
- Private limited company.
- Public company or special structures only when operationally supported.
- Local, expatriate and foreign ownership.
- Existing-business onboarding.
- Bangladesh versus Outside Bangladesh branching.

Preserve the approved first choice:

1. **Bangladesh**
2. **Outside Bangladesh**

If Outside Bangladesh is selected, show the supported country selector immediately. If Bangladesh is selected, ask New business or Existing business, then adapt by entity/activity. International country links remain understated in the footer, but every approved country route must create a real case immediately.

The Start workspace must include:

- Recommendation with alternatives and evidence.
- Name-clearance preparation.
- Founders/directors/shareholders/proprietor/partners.
- Ownership and capital schedule.
- Business activities and proposed objects.
- Registered-office/premises evidence.
- MOA/AOA and prescribed-document workflow where relevant.
- Identity and business verification gates.
- Government fee estimate separated from bdoor/provider fees.
- Electronic consent/signature sequence where lawful.
- Filing status and authority reference.
- Post-registration checklist.
- Trade licence, TIN, BIN/VAT, banking readiness and sector licences.
- Handoff into bdoor Comply without re-entering data.

Do not advertise automated authority submission unless a documented lawful integration exists and works in production. Otherwise create a specialist-reviewed managed application with transparent status.

### 4.8 bdoor Comply

bdoor Comply is the primary recurring product and must work for businesses formed elsewhere.

Create:

- Good-standing/compliance overview without implying an official government status unless verified.
- Obligations grouped as Due now, Upcoming, Awaiting information, Under review, Filed, Accepted, Overdue and Not applicable.
- RJSC annual and event-driven returns.
- Income-tax and withholding obligations.
- VAT/BIN returns and certificates.
- Trade-licence and sector-licence renewals.
- Director, shareholder, capital, address and constitutional changes.
- Employment, factory, fire, environment and relevant sector reminders.
- Evidence-backed change alerts.
- One-click request to prepare a filing.
- Customer review/approval before submission.
- Provider assignment where professional work is required.
- Receipt, acknowledgement, rejection and correction tracking.

Offer configurable service levels such as Monitor, Prepare and Managed, but do not publish final names/prices until founder approval. Never use “autopilot” to imply that bdoor can file without customer information, consent or professional/legal requirements.

### 4.9 bdoor Books

bdoor Books is human-reviewed bookkeeping assisted by software and AI.

Minimum product:

- Chart of accounts by entity and industry.
- CSV/statement import with secure bank-feed adapters only when a valid integration exists.
- Receipts and expense documents.
- AI-assisted transaction suggestion with human confirmation/review.
- Customer/vendor records.
- Invoices and payment-status tracking.
- Bank/cash reconciliation.
- Monthly close checklist.
- Profit and loss, balance sheet, cash flow and ledger exports.
- VAT and withholding schedules.
- Tax-ready year-end package.
- Investor-ready reporting and data-room export.
- Bookkeeper questions, customer answers and review trail.

Do not let AI post irreversible journal entries without approval. Preserve original imported data and every adjustment. Statutory audits must be assigned to qualified independent auditors; do not market ordinary bdoor bookkeeping as an audit.

### 4.10 bdoor Address

bdoor Address is a controlled operational service, not a decorative virtual-office claim.

Before launch:

- Obtain lawful premises/partner arrangements.
- Define which entity and authority use cases the address can support.
- Obtain written customer authorisation for receiving, opening, scanning, forwarding, archiving and destroying mail.
- Establish identity/business verification, prohibited-use rules, retention, privacy, physical security and chain of custody.
- Confirm courier/postal handling and package limitations.
- Insure and operationally test the service where appropriate.

Product workflow:

- Select eligible location/use case.
- Verify customer and business.
- Execute address/mail authorisation.
- Allocate address/instructions.
- Log incoming item with timestamp and handler.
- Notify authorised users.
- Scan envelope; open/scan contents only when authorised.
- Let the customer request collect, forward, archive or secure destruction.
- Charge transparent postage/handling separately.
- Maintain access and action audit logs.

Display an applicability matrix for RJSC registered office, trade licence, VAT/BIN, bank KYC, courier/general correspondence and sector licences. “Eligibility requires review” is acceptable; automatic universal acceptance is not.

### 4.11 bdoor Connect

bdoor Connect is a consent-based partner and growth-tool layer.
...
- Payroll and HR.
- Insurance.
- Accounting/POS/invoicing software.
- Cloud, communications and cybersecurity.
- Coworking and office services.
- Logistics, courier, import/export and freight.
- E-commerce and sales tools.
- Founder training, accelerators and verified funding programmes.

Requirements:

- Show only signed/verified partners and current offers.
- Record offer eligibility, dates, limitations and commercial relationship.
- Clearly disclose referral compensation.
- Obtain consent before transmitting bdoor ID/profile fields.
- Display the exact fields to be shared.
- Record consent, submission, partner response and revocation.
- Never claim that banking, payment, credit, insurance or funding approval is guaranteed.
- Do not fabricate savings values or partner logos.

### 4.12 bdoor Discovery

Do not launch a fake investor marketplace. Build Discovery as a future opt-in layer of Investor Readiness:

- Founder explicitly opts in.
- Founder chooses which verified profile, metrics and documents are visible.
- Investors must be verified and accept permitted-use/confidentiality terms.
- No personal, tax, KYC or full ownership documents are exposed by default.
- Founders can see access requests and revoke access.
- bdoor does not imply investor endorsement, fundraising success or due diligence completion.

Until a real investor network exists, label this **Investor Readiness**, not Discovery, and focus on cap table, compliance, KPIs and permissioned data-room preparation.

### 4.13 bdoor for Partners and API

Architect distribution after the direct product works:

- Referral links with attribution and transparent commission rules.
- Professional-firm multi-client workspace.
- Reseller/white-label configuration only under approved contracts.
- Embeddable Start eligibility widget.
- Versioned formation/application API.
- Regulatory-intelligence API for approved non-personal data.
- Webhooks for consented case status.
- Idempotency, scoped credentials, rate limits, audit logs and tenant isolation.

Do not expose internal Supabase tables as an API product. Create a deliberately versioned service contract and separate enterprise access controls.
...
2. Start or add your business: one assessment becomes a roadmap and profile.
3. Run it from one workspace: bdoor ID, Comply and Books.
4. Address and Connect only when those products/partners are genuinely operational.
5. Verified provider review plus final Ask/Start action.

Use a compact product switcher or horizontal list, not six oversized marketing cards. A product behind a disabled feature flag must not appear as available, accept payment or use a misleading “coming soon” sales CTA. It may be omitted or shown in a clearly labelled roadmap area for signed-in beta users.
...
### 5.5 Information architecture and routes

Reuse current locale routing. Final route names may follow repository conventions, but the information architecture must provide:

- `/{locale}` — simple AI-first Bangladesh homepage.
- `/{locale}/ask` — full bdoor AI.
- `/{locale}/start` — Bangladesh/Outside Bangladesh branching intake.
- `/{locale}/products/start` — concise Start explanation and entry.
- `/{locale}/products/comply` — continuing compliance.
- `/{locale}/products/books` — bookkeeping/tax-ready financials.
- `/{locale}/products/address` — only when operationally eligible.
- `/{locale}/products/connect` — only for signed partners/offers.
- `/{locale}/workspace` — signed-in organisation home.
- `/{locale}/workspace/businesses/{businessId}` — bdoor ID and business command centre.
- `/{locale}/workspace/compliance` — obligations and filings.
- `/{locale}/workspace/books` — bookkeeping and reports.
- `/{locale}/workspace/mail` — address/mail operations.
- `/{locale}/workspace/partners` — consented partner applications/offers.
- `/{locale}/provider` — firm-scoped provider portal.
- `/{locale}/admin` — role-scoped operations and intelligence.
- `/api/v1/...` — future versioned external API; never expose raw tables.

Within the signed-in workspace use one consistent left navigation on desktop and a compact accessible mobile navigation. Show product availability based on the organisation, plan, feature flags and operational eligibility—not static marketing assumptions.

### 5.6 Unified onboarding and upgrade journeys

Required journeys:

1. Guest question → useful answer → optional roadmap → sign up → saved business profile.
2. New business → Start application → formation case → bdoor ID → post-formation tasks → Comply offer.
3. Existing business → import/verify → bdoor ID → compliance health assessment → Comply/Books.
4. Comply customer → obligation → preparation → approval → provider/filing → evidence stored.
5. Books customer → import → review → close → statements → tax/investor readiness.
6. Address applicant → eligibility/verification → authorisation → allocation → digital mail workflow.
7. Connect user → offer → data-sharing preview → consent → partner application → status.
8. Professional firm → approval → assigned client/case → secure work → deliverable → SLA/quality data.

Each transition must preserve context and avoid repeated questions. Never hide a mandatory professional or government fee until checkout.
...
### 9.5 Recurring-product and distribution data

Model or extend these concepts without duplicating existing tables:

- product catalogue, plans, entitlements and feature flags.
- subscriptions, billing periods, renewal state and cancellation reasons.
- organisation product enrolments.
- compliance rules, instantiated obligations, filing attempts and evidence.
- bookkeeping accounts, imports, transactions, classifications, reconciliations, periods, adjustments and statements.
- address locations, eligibility policies, address agreements and authorised mail actions.
- mail items, scans, custody events, forwarding/destruction requests and charges.
- partners, offers, eligibility, referral terms and effective dates.
- consented data-sharing requests and exact disclosed fields.
- partner applications and responses.
- referral links, attribution and commission records.
- API clients, scoped credentials, usage, idempotency records and webhooks.
- investor-readiness profiles, opt-ins, access requests and data-room permissions.

Accounting data requires immutable source imports and auditable adjustments. Mail data requires chain of custody. Partner sharing requires field-level consent evidence. Subscription state must never be inferred only from a client-side flag.
...
Preserve the six currently approved Bangladesh packages and their BDT pricing until the founder explicitly approves a pricing migration. Internally map their included services to the new Start/Comply/Books capability model so existing links, quotes and customer expectations do not break.

### 13.1A Packaging architecture

Support configurable packages without hardcoding entitlements in UI components:

- **Start:** one-time formation/onboarding scope plus itemised authority/third-party fees.
- **Comply Monitor:** dashboard, calendar and reminders.
- **Comply Prepare:** Monitor plus document/filing preparation.
- **Comply Managed:** Prepare plus coordinated provider execution and status tracking.
- **Books:** recurring bookkeeping priced by an approved operational driver such as transaction volume/complexity, not arbitrary AI output.
- **Address:** recurring location/mail tier plus usage/forwarding charges.
- **Connect:** usually included access; revenue comes from disclosed partner/referral/integration arrangements.
- **Business Intelligence/API:** usage-based or contracted enterprise access to approved data/services.

Names above are working architecture labels and require founder approval before public use. Do not imitate Firstbase/doola price points or publish discounts unsupported by bdoor's unit economics.

### 13.1B Revenue loops

Instrument these genuine loops:

1. AI answer → roadmap → Start conversion.
2. Start completion → bdoor ID → Comply activation.
3. Comply obligation → recurring preparation/managed service.
4. Books close → tax/VAT/compliance action.
5. Verified business profile → consented Connect application.
6. Existing business import → health assessment → Comply/Books.
7. Provider capacity → faster case completion → retention/referral.
8. API/referral partner → new formation → continuing product revenue.

Measure cohort retention and gross margin for each loop. Formation revenue alone is not evidence of a scalable recurring software company.
...
- Start-to-Comply attach rate.
- Comply renewal rate.
- Books monthly-close completion and retention.
- Address occupancy, mail actions and contribution margin when launched.
- Connect application/approval/referral conversion without implying partner approval.
- Percentage of revenue that is recurring.
- Net revenue retention by product cohort.
- AI cost and provider labour cost per resolved customer outcome.
...
- Start completed and post-formation task completed.
- Compliance obligation created/prepared/approved/filed/accepted/rejected.
- Books source imported, transaction reviewed, reconciliation completed and period closed.
- Address eligibility started/approved and mail action completed.
- Connect offer viewed, sharing preview opened, consent granted/revoked and application status changed.
- Existing business imported and verified.
- API/referral conversion attributed.
...
- Playwright test: new Bangladesh business → Start → submitted case → bdoor ID → Comply offer without repeated data.
- Playwright test: existing business → import/verify → compliance assessment.
- Playwright test: compliance obligation → preparation → customer approval → provider assignment → evidence/result.
- Playwright test: Books import → suggestion review → reconciliation → period close → statement export.
- Playwright test: Address eligibility denial/approval and authorised mail action, kept feature-flagged until operational.
- Playwright test: Connect data-sharing preview → consent → partner submission → revocation/audit.
- Contract test for external API scopes, idempotency, tenant isolation and webhook signatures before API launch.
...
No feature passes merely because its page renders. Every enabled CTA must create the expected durable state, enforce the correct permission and show the user an accurate result or recoverable error.
...
### Phase 3 — bdoor Start, ID and business workspace

- Business profiles and verification.
- New and existing business onboarding.
- One-time canonical data capture and provenance.
- Current Bangladesh package compatibility.
- Personalised roadmap.
- Customer workspace and secure documents.

### Phase 4 — bdoor Comply and provider operations

- Compliance rule instantiation, obligations and reminders.
- Preparation, approval, assignment, filing evidence and result states.
- Provider-firm onboarding and verification.
- Firm/team permissions.
- Assignments, conflicts, SLA, quotes and deliverables.
- Recurring-plan entitlements and renewal instrumentation.

### Phase 5 — bdoor Books

- Accounting data model and immutable imports.
- AI-assisted categorisation with human approval.
- Reconciliation, monthly close and statements.
- Tax/VAT schedules and investor-ready exports.
- Accountant/bookkeeper provider workflows.

### Phase 6 — High-value domain expansion
...
### Phase 7 — bdoor Address, Connect and distribution

- Address eligibility, agreements and controlled pilot operations.
- Mail custody, scans, customer actions and charges.
- Signed partner/offer registry and consented data sharing.
- Referral attribution and commission records.
- Versioned partner/API foundation.

### Phase 8 — Monetisation and investor readiness
...
- Recurring-revenue cohorts and attach/renewal metrics.
- Optional investor-readiness access requests; no public investor marketplace until a verified network exists.
...
15. Product entitlement matrix for AI, Start, Comply, Books, Address and Connect.
16. Existing-package compatibility/migration map.
17. Address operational-readiness and authority-applicability matrix.
18. Partner disclosure, consent and referral-control documentation.
19. Unit-economics measurement specification by product.
20. Phased go-to-market and feature-flag status table.
...
- Address launches only after premises, authorisation, privacy, custody, security and applicability controls are operationally approved.
- Connect launches each offer only after a signed partner arrangement, current offer verification, referral disclosure and data-sharing consent flow exist.
- Books launches managed reporting only when responsible human reviewers/providers and close/review procedures are assigned.
- No investor-discovery claims appear until verified investors and a permissioned access process genuinely exist.
...
> Read `BDoor_Firstbase_Inspired_Business_Intelligence_OS_Master_Claude_Code_Instruction_2026-08-31.md` completely. Treat it as the replacement product instruction. Inspect the current repository, open PRs, live production site, Vercel project, installed AI SDK documentation and Supabase schema before editing. Create or switch to `feat/bdoor-business-intelligence-os`. Implement the instruction in phased, tested, feature-flagged increments. Preserve the current compact Ask bdoor AI direction, Bangladesh/Outside Bangladesh intake order, approved Bangladesh packages, bilingual routes, legal gates and all working production data. Fix the existing latency and official-source retrieval failures first. Then build the shared bdoor ID/data layer and the connected product family: bdoor AI, Start, Comply, Books, controlled Address pilot and signed-partner Connect. Build the versioned Bangladesh knowledge graph, provider portal, admin intelligence system, recurring-revenue instrumentation, distribution/API foundation and evaluation gates. Use Vercel AI Gateway for dynamic multi-provider routing and failover; do not hardcode obsolete models. Use additive Supabase migrations with strict RLS and tenant isolation. Do not copy Firstbase, Stripe Atlas or doola code, designs, wording, pricing, protected data, US registered-agent assumptions or partner claims. Run typecheck, lint, formatting, unit, integration, RLS, accessibility, performance and Playwright tests. Create a Vercel preview and a complete evidence-based implementation report. Do not deploy production, change production secrets, enable legally gated payments/KYC, fabricate content or stop after planning.

### Research references for product translation

Claude Code must recheck current pages before relying on implementation details:

- Firstbase Start: <https://www.firstbase.io/start>
- Firstbase Agent/compliance: <https://www.firstbase.io/agent>
- Firstbase Mailroom: <https://www.firstbase.io/mailroom>
- Firstbase Loop: <https://www.firstbase.io/loop>
- Firstbase Accounting: <https://www.firstbase.io/accounting>
- Firstbase Partners/API model: <https://www.firstbase.io/affiliates>
- Firstbase Rewards: <https://www.firstbase.io/rewards>
- Stripe Atlas: <https://stripe.com/atlas>
- Stripe Atlas documentation: <https://docs.stripe.com/atlas>
- doola product/pricing structure: <https://www.doola.com/pricing/>
- RJSC portal: <https://app.roc.gov.bd/>
- RJSC registration process: <https://app.roc.gov.bd/Guidlines/RJSC_bus_pro_Reg.htm>
- RJSC returns process: <https://app.roc.gov.bd/Guidlines/RJSC_bus_pro_RF.htm>
- Companies Act, 1994: <https://bdlaws.minlaw.gov.bd/act-788.html>
- Invest Bangladesh/BIDA FAQ: <https://bida.gov.bd/faq>
- Invest Bangladesh/BanglaBiz: <https://bida.gov.bd/>
- NBR publications: <https://nbr.gov.bd/publications/all-publication/eng>
- Bangladesh Bank circulars: <https://www.bb.org.bd/en/index.php/mediaroom/circular>

These references inform product and source design. They do not grant permission to copy third-party content or represent private-company claims as Bangladesh law.
