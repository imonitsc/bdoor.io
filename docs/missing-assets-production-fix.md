...
| -------------------------- | -------------------------- | ------------------------------------------------------- |
| `open-door-dhaka.webp`     | Homepage hero              | An open doorway overlooking Dhaka's business district   |
...
Layout components are ready (`HeroDoorImage`, `HowItWorksImage`). Until the files arrive, the slots render a dashed missing-asset placeholder — no stock substitutes were added.
