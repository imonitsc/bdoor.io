...
Working notes for an agent (or a new engineer) changing this repository. The
README explains what BDoor is and how to run it; this file is about how to work
in it without breaking the things that matter.

Read `README.md` first. This file assumes it.
